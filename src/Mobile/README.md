...
eShop is a reference app whose imagined purpose is to serve the mobile workforce of a fictitious company that sells products. The app allow to manage the catalog, view products, manage the basket and the orders.

<img src="Images/eShop_Architecture_Diagram.png" alt="eShop" Width="800" />
...
As of 07/03/2017, eShop features **89.2% code share** (7.2% iOS / 16.7% Android / 8.7% Windows).
...
## Requirements
### Requirements for March 2017 version of eShop
