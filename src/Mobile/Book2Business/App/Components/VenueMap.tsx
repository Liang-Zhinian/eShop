...
class VenueMap extends React.Component<VenueMapProps, VenueMapState> {
  ...
  *************************************************************/
  ...
  //     console.log('VenuMap componentDidMount', this.props)
  //     const region = calculateRegion(this.props.locations, { latPadding: 0.1, longPadding: 0.1 });
  //     console.log('VenuMap componentDidMount region', region)
  //     this.setState({
  //       region
  //     })
  //   }
