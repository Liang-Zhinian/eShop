using eShop.Core.Controls;
using eShop.Windows.Controls;
using eShop.Windows.Extensions;
using eShop.Windows.Helpers;
using eShop.Windows.Renderers;
...
namespace eShop.Windows.Renderers
{
    [Preserve]
