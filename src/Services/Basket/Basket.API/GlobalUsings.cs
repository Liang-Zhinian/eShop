...
global using Eva.eShop.Services.Basket.API.Infrastructure.Repositories;
global using Eva.eShop.Services.Basket.API.IntegrationEvents.EventHandling;
global using Eva.eShop.Services.Basket.API.IntegrationEvents.Events;
global using Eva.eShop.Services.Basket.API.Model;
global using Eva.eShop.Services.Basket.API.Services;
