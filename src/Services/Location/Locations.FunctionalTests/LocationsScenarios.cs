        ...
        : LocationsScenarioBase
    {
        ...
        public async Task Set_new_user_seattle_location_response_ok_status_code()
        {
            using (var server = CreateServer())
            {
                ...
                var location = JsonConvert.DeserializeObject<Eva.eShop.Services.Locations.API.Model.Locations>(responseBody);
        ...
        public async Task Get_all_locations_response_ok_status_code()
        {
            using (var server = CreateServer())
            {
                ...
                var locations = JsonConvert.DeserializeObject<List<Eva.eShop.Services.Locations.API.Model.Locations>>(responseBody);
