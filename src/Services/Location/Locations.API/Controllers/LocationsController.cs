...
namespace Locations.API.Controllers
{
    ...
    public class LocationsController : ControllerBase
    {
        ...
        [Route("")]
        [HttpGet]
        [ProducesResponseType(typeof(List<Eva.eShop.Services.Locations.API.Model.Locations>), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<List<Eva.eShop.Services.Locations.API.Model.Locations>>> GetAllLocationsAsync()
        {
        ...
        [Route("{locationId}")]
        [HttpGet]
        [ProducesResponseType(typeof(Eva.eShop.Services.Locations.API.Model.Locations), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<Eva.eShop.Services.Locations.API.Model.Locations>> GetLocationAsync(int locationId)
        {
