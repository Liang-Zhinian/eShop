...
namespace SaaSEqt.eShop.Services.IndustryStandardCategory.API.Infrastructure
{
    ...
    using global::IndustryStandardCategory.API.Extensions;
    ...
    public class CategoryContextSeed
    {
        ...
        public async Task SeedAsync(CategoryContext context, IHostingEnvironment env, IOptions<CategorySettings> settings, ILogger<CategoryContextSeed> logger)
        {
