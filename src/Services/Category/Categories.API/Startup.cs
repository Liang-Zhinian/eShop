namespace SaaSEqt.eShop.Services.IndustryStandardCategory.API
{
    ...
    using global::IndustryStandardCategory.API.Infrastructure.Filters;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHealthChecks(checks =>
            {
                ...
                checks.AddMySQLCheck("CategoryDb", Configuration["ConnectionString"], TimeSpan.FromMinutes(minutes));
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "eShop - Industry Standard Category HTTP API",
                    Version = "v1",
                    Description = "The Industry Standard Category Microservice HTTP API. This is a Data-Driven/CRUD microservice sample",
            ...
            if (Configuration.GetValue<bool>("AzureServiceBusEnabled"))
            {
                ...
                {
                    var settings = sp.GetRequiredService<IOptions<CategorySettings>>().Value;
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
            ...
            app.UseSwagger()
              .UseSwaggerUI(c =>
              {
                  c.SwaggerEndpoint($"{ (!string.IsNullOrEmpty(pathBase) ? pathBase : string.Empty) }/swagger/v1/swagger.json", "IndustryStandardCategory.API V1");                  
              });
