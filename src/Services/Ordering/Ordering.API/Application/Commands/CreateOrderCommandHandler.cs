namespace SaaSEqt.eShop.Services.Ordering.API.Application.Commands
{
        ...
        : IRequestHandler<CreateOrderCommand, bool>
    {
        ...
        public async Task<bool> Handle(CreateOrderCommand message, CancellationToken cancellationToken)
        {
            ...
            var order = new Order(message.MerchantId, message.UserId, message.UserName, address, message.CardTypeId, message.CardNumber, message.CardSecurityNumber, message.CardHolderName, message.CardExpiration);
