namespace SaaSEqt.eShop.Services.ServiceCatalog.API
{
    ...
    //using SaaSEqt.eShop.Services.ServiceCatalog.API.IntegrationEvents.EventHandling;
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
            ...
            app.UseSwagger()
              .UseSwaggerUI(c =>
              {
                  c.SwaggerEndpoint($"{ (!string.IsNullOrEmpty(pathBase) ? pathBase : string.Empty) }/swagger/v1/swagger.json", "ServiceCatalog.API V1");                  
              });
