...
namespace SaaSEqt.eShop.Services.IdentityAccess.API.Infrastructure
{
    using System;
    using System.IO;
    using System.Linq;
    ...
    {
        public async Task SeedAsync(IdentityAccessDbContext context,IHostingEnvironment env,IOptions<IdentityAccessSettings> settings,ILogger<IdentityAccessContextSeed> logger)
        {
