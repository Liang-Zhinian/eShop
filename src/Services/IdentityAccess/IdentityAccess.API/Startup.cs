namespace SaaSEqt.eShop.Services.IdentityAccess.API
{
    ...
    using global::IdentityAccess.API.Infrastructure.Filters;
    ...
    using SaaSEqt.eShop.Services.IdentityAccess.API.Configurations;
    using SaaSEqt.eShop.Services.IdentityAccess.API.Infrastructure;
    using SaaSEqt.eShop.Services.IdentityAccess.API.Infrastructure.AutofacModules;
    using SaaSEqt.eShop.Services.IdentityAccess.API.Infrastructure.Middlewares;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<IdentityAccessSettings>(Configuration);
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        private void ConfigureAuthService(IServiceCollection services)
        {
            ...
            }).AddJwtBearer(options =>
            {
                ...
                options.Audience = "identityaccess";
