...
namespace SaaSEqt.eShop.Mobile.Reservation.HttpAggregator.Services
{
    public interface IBusinessLocationService
    {
        ...
        Task<PaginatedItemsViewModel<Location>> GetBusinessLocationsWithinRadius(double latitude, double longitude, double radius, string searchText, int pageSize = 10, int pageIndex = 0);
