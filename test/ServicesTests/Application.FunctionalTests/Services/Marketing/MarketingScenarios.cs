...
{
    using UserLocation = Eva.eShop.Services.Locations.API.Model.UserLocation;
    using LocationRequest = Eva.eShop.Services.Locations.API.ViewModel.LocationRequest;
