...
{
    using UserLocation = SaaSEqt.eShop.Services.Locations.API.Model.UserLocation;
    using LocationRequest = SaaSEqt.eShop.Services.Locations.API.ViewModel.LocationRequest;
